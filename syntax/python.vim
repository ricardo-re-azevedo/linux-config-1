...
syn keyword pythonSpecialStatement  def class nextgroup=pythonFunction skipwhite
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonSpecialStatement Define
  ...
  HiLink pythonBuiltinObj       StorageClass
